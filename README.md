...
>“look into each [repo] a bit but i'd want u to pivot from that briefly to write a basic fastapi app. as basic as possible with one /health route. returns {status:ok} json”

>“hand write it. no AI for writing code.”
